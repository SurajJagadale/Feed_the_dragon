...
background = pygame.image.load('C:/Users/pc/Desktop/feed_dragon-main/dragon_night.jpg')
background_rect = background.get_rect()
background_rect.topleft = (0,0)

#setup the actors
coin = pygame.image.load('C:/Users/pc/Desktop/feed_dragon-main/coin.png')
coin_rect = coin.get_rect()
coin_rect.left = BUFFER_DISTANCE
coin_rect.top = random.randint(64, WINDOW_HEIGHT-64)


dragon = pygame.image.load('C:/Users/pc/Desktop/feed_dragon-main/dragon.png')
dragon_rect = dragon.get_rect()
dragon_rect.centery = WINDOW_HEIGHT//2
dragon_rect.right = WINDOW_WIDTH -10

#setup the sound and music
pickup = pygame.mixer.Sound('C:/Users/pc/Desktop/feed_dragon-main/pickup.wav')
loss = pygame.mixer.Sound('C:/Users/pc/Desktop/feed_dragon-main/loss.wav')

pygame.mixer.music.load('C:/Users/pc/Desktop/feed_dragon-main/background_music.mp3')
...
#font
game_font = pygame.font.Font('C:/Users/pc/Desktop/feed_dragon-main/aAttackGraffiti.ttf', 32) #fontname, fontsize

#texts
lives = game_font.render('Lives : ' + str(current_player_lives), True,  RED)
lives_rect = lives.get_rect()
lives_rect.top = 10
lives_rect.left = 50

title = game_font.render('Feed the Dragon',True, RED)
title_rect = title.get_rect()
title_rect.top = 10
title_rect.centerx = WINDOW_WIDTH//2

score = game_font.render('Score : ' + str(current_player_score), True,  RED)
...
replay = game_font.render('Press r to REPLAY!', True, RED)
...
async def main():
    global running,game_status,current_coin_velocity,lives,score,current_player_lives  # Declare 'running' as global within the coroutine
    running = True
    while running:
